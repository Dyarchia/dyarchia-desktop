...
from euripontida_crawlee.errors import CrawleeLabError, ProfileError
from euripontida_crawlee.profiles.schema import ProfileSpec
from euripontida_crawlee.versioning.vcs import commit_path, is_ignored, repository_root
...
def save_profile_file(profile: ProfileSpec, directory: Path) -> Path:
    """Write a profile out, without touching git. See `save_profile` for the versioned form."""
