...
from euripontida_crawlee.extraction.strategies import main_content
from euripontida_crawlee.models import CrawlerKind
from euripontida_crawlee.urls import suffix_candidates
...
class Recon:
    ...
    def recommended_crawler(self) -> CrawlerKind:
        if self.markdown_url is not None:
            return CrawlerKind.HTTP
        if self.needs_browser:
            return CrawlerKind.PLAYWRIGHT
        return CrawlerKind.BEAUTIFULSOUP
