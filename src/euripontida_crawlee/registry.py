...
`euripontida_crawlee.sites` that expose a module-level `PROFILE`. A YAML file wins over a Python module of
...
from euripontida_crawlee import sites
from euripontida_crawlee.config import Settings, get_settings
from euripontida_crawlee.errors import ProfileError
from euripontida_crawlee.profiles.loader import PROFILE_SUFFIXES, load_profile_file
